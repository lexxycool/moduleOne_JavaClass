...
public class Lecture {
    ...
    */
    public double returnDoubleOfTwo() {  // changed int to double in method signature
        //  double is the data type of the data being returned.
        return 2;
    }
    ...
    */
    public boolean returnTrueFromIf() {
        ...
        if (true) {  // we have a return statement inside the if block
            return true;  // return ends the method block and sends app back to who called
                          // the method
        }
    ...
    */
    public boolean returnTrueWhenOneEqualsOne() {
        boolean result = false;  // created a variable to hold boolean
                                // initialize it to false

        if (1 == 1) {  // if condition is true
            result = true;  // change my boolean to hold the value of true
        }

        return result;  // the value stored in the boolean var result
    }
    ...
    */
    public boolean returnTrueWhenGreaterThanFive(int number) {
                    // inside the parens is a variable called number
                    // it can be used inside this method only
    ...
    */
    public String returnFizzIfThree(int number) {
        if(number == 3){
            return "Fizz";  // if condition is true, this will end the method
        }
        return "";
    }
    ...
    */
    ...
    /*
    14. Write an if statement that checks if the parameter number is either equal to
     or greater than 18. Return "Adult" if it is or "Minor" if it's not.
    */
    ...
    */
    public String returnAdultOrMinorOrTeen(int number) {
        if (number >= 18) {
            return "Adult";
        } else if (number >= 13) {  // we know because of the else, number must be <= 17
            return "Teen";
        } else {
            return "Minor";
        }
